...
const LEGACY_SUBCATEGORY_CANONICAL_PATHS: Record<string, string> = {
  ...
  "zadvizhki-klinovye": catalogSubcategoryListingHref("zadvizhki", "zadvizhki-klinovye"),
  ...
  "zadvizhki-pn40-pn64": catalogSubcategoryListingHref("zadvizhki", "zadvizhki-pn40-pn64"),
  "zadvizhki-pod-privarku": catalogSubcategoryListingHref("zadvizhki", "zadvizhki-pod-privarku"),
