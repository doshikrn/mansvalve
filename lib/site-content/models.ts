...
export const DEFAULT_HOME_HERO: HomeHeroContent = {
  ...
  subhead:
    "Делаем КП с ценой, сроком и документами за 1 рабочий день. Поставки с заводов и со склада в Алматы по всему Казахстану.",
  primaryCta: "Получить КП за 1 день",
  secondaryCta: "Отправить ТЗ на почту",
  trustPoints: [
    "Склад в Алматы",
...
export const DEFAULT_REQUEST_CTA: RequestCtaContent = {
  ...
  subtitle:
    "Оставьте контакт и задачу — в рабочее время свяжемся в течение 1-2 часов и направим КП до конца рабочего дня.",
...
export const DEFAULT_HOME_FAQ: HomeFaqContent = {
  ...
  items: [
    ...
    },
    {
      ...
      a: "1 рабочий день после получения спецификации или параметров (DN, PN, среда, объёмы). Под тендер готовим полный пакет документов за тот же срок.",
    },
    {
...
export const DEFAULT_ABOUT_COPY: AboutCopyContent = {
  ...
  ctaSubtitle:
    "Свяжитесь с нами — подберём арматуру под ваш объект и подготовим коммерческое предложение за 2 часа.",
};
...
export const DEFAULT_CONTACTS_COPY: ContactsCopyContent = {
  pageLead:
    "Работаем с B2B-клиентами по всему Казахстану. Ответим в течение 2 рабочих часов.",
  formTitle: "Получить КП",
  formHelper:
    "Укажите контакт и что вас интересует — подберём позиции и подготовим КП с ценами.",
};
