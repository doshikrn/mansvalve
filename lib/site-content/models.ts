...
export const DEFAULT_FOOTER_MAIN: FooterMainContent = {
  ...
  catalogLinks: [
    ...
    { label: "Обратные клапаны", href: "/catalog/podemnye" },
...
export function createDefaultPrivacyPage(): PrivacyPageContent {
  return {
    ...
    metaDescription:
      "Политика обработки персональных данных: заявки, cookie, аналитика, хранение лидов, контакты по вопросам данных.",
    ogDescription: "Как обрабатываются данные на сайте: формы, UTM, хранение заявок.",
    ...
    sections: [
      ...
      },
      {
        ...
        bodyParagraphs: [
          "Копия заявки с теми же сведениями сохраняется во внутренней базе данных и доступна сотрудникам с учётной записью через закрытую админ‑панель — для ведения переговоров, статусов сделок и обратной связи с вами. Срок хранения обоснован деловой необходимостью; при отсутствии такой необходимости данные не используем.",
        ],
      },
      {
