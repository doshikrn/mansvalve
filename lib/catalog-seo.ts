...
> = {
  zadvizhki: {
    title: "Задвижки чугунные и стальные — Казахстан",
    description:
  ...
  klapany: {
    title: "Обратные клапаны — купить в Казахстане",
    description:
...
export const CATALOG_LANDING_PAGES: CatalogLandingPage[] = [
  {
    ...
    slug: "30ch6br",
    title: "Задвижка чугунная 30ч6бр — Казахстан",
    description:
  ...
  },
  {
    categorySlug: "zadvizhki",
    slug: "30s41nzh",
    title: "Задвижка стальная 30с41нж — Казахстан",
    description:
  ...
  },
  {
    ...
    title: "Задвижки с электроприводом — Казахстан",
    description:
  ...
  },
  {
    ...
    slug: "mezhflantsevye",
    title: "Затворы дисковые межфланцевые — Казахстан",
    description:
  ...
  },
  {
    ...
    slug: "ru16",
    title: "Фланцы Ру16 купить в Казахстане",
    description:
