...
> = {
  zadvizhki: {
    title: "Задвижки купить в Казахстане — чугунные и стальные",
    description:
  ...
  klapany: {
    title: "Купить обратные клапаны в Казахстане оптом",
    description:
...
export const CATALOG_LANDING_PAGES: CatalogLandingPage[] = [
  ...
  },
  {
    ...
    title: "Задвижки с электроприводом купить в Казахстане",
    description:
  ...
  },
  {
    ...
    slug: "mezhflantsevye",
    title: "Затворы дисковые межфланцевые купить в Казахстане",
    description:
