...
export const metadata: Metadata = {
  ...
  title: {
    default: `${COMPANY.name} — Промышленная арматура в Казахстане`,
    template: `%s | ${COMPANY.name}`,
  },
  description:
    "Задвижки, краны шаровые, затворы и клапаны от DN15 до DN1000. Прямые поставки, сертификаты ГОСТ/DIN/ISO, доставка по всему Казахстану. Комплект за 1 день.",
  keywords:
    "задвижки, краны шаровые, затворы, клапаны, промышленная арматура, Казахстан, ГОСТ, DN, PN",
  openGraph: {
    title: `${COMPANY.name} — Промышленная арматура в Казахстане`,
    description:
