...
/**
 * Global 404. Rendered under the root layout for unmatched URLs, so it
 * reuses the public-site chrome (Header / Footer / FloatingWhatsApp) directly
 * rather than the `(site)` route-group layout.
 */
    ...
    <PublicMotionProvider>
      ...
      <main className="flex-1 bg-site-bg">
        <div className="mx-auto flex max-w-3xl flex-col items-center px-4 py-20 text-center sm:px-6 lg:py-28">
          <p className="text-5xl font-bold tracking-tight text-site-primary sm:text-6xl">
            404
          </p>
