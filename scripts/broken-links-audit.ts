...
const EXPECTED_ROUTE_CHECKS: ExpectedRouteCheck[] = [
  ...
  {
    label: "legacy category slug zatvory redirects to zatvory-diskovye",
    href: "/catalog/zatvory",
    expectedStatus: 200,
    expectedFinalPath: "/catalog/zatvory-diskovye",
    expectedRedirectCount: 1,
  },
  {
    label: "legacy category slug klapany redirects to klapany-obratnye",
    href: "/catalog/klapany",
    expectedStatus: 200,
    expectedFinalPath: "/catalog/klapany-obratnye",
    expectedRedirectCount: 1,
  },
  {
    label: "legacy landing zatvory/mezhflantsevye redirects to catalog subcategory",
    href: "/zatvory/mezhflantsevye",
    expectedStatus: 200,
    expectedFinalPath: "/catalog/zatvory-diskovye-mezhflantsevye",
    expectedRedirectCount: 1,
  },
  {
    label: "legacy flat klinovye subcategory redirects to category filter",
    href: "/catalog/zadvizhki-klinovye",
    expectedStatus: 200,
    expectedFinalPath: catalogSubcategoryListingHref("zadvizhki", "zadvizhki-klinovye"),
    expectedRedirectCount: 1,
  },
  {
  ...
  {
    label: "butterfly valves query page redirects to clean subcategory URL",
