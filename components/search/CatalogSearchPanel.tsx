...
export function CatalogSearchPanel({
  ...
  return (
    ...
    >
      ...
      <form onSubmit={handleFormSubmit} className="p-3 pb-2" role="search">
        <label className="relative block">
          ...
          <input
            ...
            className="h-11 w-full rounded-xl border border-slate-200 bg-slate-50/80 pl-9 pr-3 text-sm text-slate-900 shadow-inner outline-none transition focus:border-blue-500 focus:bg-white"
            placeholder="Название, DN, PN, модель…"
            autoComplete="off"
            autoCorrect="off"
            autoCapitalize="off"
            spellCheck={false}
